...
static const gchar* _win_menubar_xml = 
"<interface>"
"  <menu id='win-menu'>"
"    <submenu>"
...
"      <section>"
"        <item>"
"          <attribute name='label' translatable='yes'>Using Kanjipad</attribute>"
"          <attribute name='action'>win.toggle-kanjipad-show</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"        <item>"
"          <attribute name='label' translatable='yes'>Using Radical Search Tool</attribute>"
"          <attribute name='action'>win.toggle-radical-search-tool-show</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"      </section>"
"      <section>"
"        <item>"
"          <attribute name='label' translatable='yes'>Word Edge Character</attribute>"
"          <attribute name='action'>win.insert-word-edge-character</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"        <item>"
"          <attribute name='label' translatable='yes'>Not Word Edge Character</attribute>"
"          <attribute name='action'>win.insert-not-word-edge-character</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"        <item>"
"          <attribute name='label' translatable='yes'>Unknown Character</attribute>"
"          <attribute name='action'>win.insert-unknown-character</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"        <item>"
"          <attribute name='label' translatable='yes'>And Character</attribute>"
"          <attribute name='action'>win.insert-and-character</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"        <item>"
"          <attribute name='label' translatable='yes'>Or Character</attribute>"
"          <attribute name='action'>win.insert-or-character</attribute>"
"          <attribute name='accel'>&lt;Primary&gt;k</attribute>"
"        </item>"
"      </section>"
"      <section>"
...
"    <submenu>"
"      <attribute name='label' translatable='yes'>Hi_story</attribute>"
"      <section>"
"        <item>"
...
//!
//! @brief PRIVATE FUNCTION. Populate the menu search lists for the back and forward buttons
//!
...
static void _rebuild_history_button_popup (GwSearchWindow *window, GtkMenu *menu, GList* list)
{
    ...
    while (children != NULL)
    {
      ...
      gint leftover = 200;
      gchar label[leftover];
      text = lw_query_get_text (search->query);
      strncpy (label, text, leftover);
      leftover -= strlen (text);
      while (leftover > 180)
      {
...
gw_searchwindow_update_tab_text_by_index (GwSearchWindow *window, gint index)
{
    ...
    if (query != NULL && lw_query_get_text (query) == NULL)
      text = lw_query_get_text (query);
...
gw_searchwindow_start_search (GwSearchWindow *window, LwSearch* new_item)
{
    ...
    g_assert (search == NULL || lw_search_get_status (search) != LW_SEARCHSTATUS_FINISHING);
    view = gw_searchwindow_get_current_textview (window);
