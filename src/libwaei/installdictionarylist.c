...
//!
LwInstallDictionaryList* 
lw_dictinstlist_new (LwPreferences *pm)
{
  curl_global_init (CURL_GLOBAL_ALL);

  LwInstallDictionary *di;
  LwInstallDictionaryList *temp;

  temp = (LwInstallDictionaryList*) malloc(sizeof(LwInstallDictionaryList));
...
void 
lw_dictinstlist_free (LwInstallDictionaryList* dil)
{
    GList *iter;
    LwInstallDictionary *di;
    ...
    {
      di = LW_INSTALLDICTIONARY (iter->data);
...
//!
gboolean 
lw_dictinstlist_data_is_valid (LwInstallDictionaryList *dil)
{
    //Declarations
    GList *iter;
    LwInstallDictionary* di;
...
//!
LwInstallDictionary* 
lw_dictinstlist_get_dictinst_fuzzy (LwInstallDictionaryList *dil, const char* FUZZY_DESCRIPTION)
{
    //Declarations
    LwInstallDictionary *di;
...
//!
LwInstallDictionary* 
lw_dictinstlist_get_dictinst_by_filename (LwInstallDictionaryList *dil, const char* FILENAME)
{
    //Declarations
    GList *iter;
    LwInstallDictionary *di;
...
//!
LwInstallDictionary* 
lw_dictinstlist_get_dictinst_by_idstring (LwInstallDictionaryList *dil, const char* ENGINE_AND_FILENAME)
{
    //Declarations
    GList *iter;
    LwInstallDictionary *di;
...
void 
lw_dictinstlist_set_cancel_operations (LwInstallDictionaryList *dil, gboolean state)
{
    LwInstallDictionary *di;
    GList *iter;
